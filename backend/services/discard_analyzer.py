...
def _calculate_discard_score(
    ...
    return undertone_score * 0.3 + body_shape_score * 0.4 + versatility_score * 0.3
...
def check_undertone_compatibility(item_color: str, user_undertone: str) -> Dict:
    ...
    if not user_undertone:
        return {
            "compatible": True,
            "score": 0.7,
            "reason": "No undertone data available",
        }
...
def check_body_shape_compatibility(item: WardrobeItem, user_body_shape: str) -> Dict:
    ...
    if not user_body_shape:
        return {
            "compatible": True,
            "score": 0.7,
            "reason": "No body shape data available",
        }
...
def calculate_item_versatility(
    item: WardrobeItem, all_items: List[WardrobeItem]
) -> Dict:
    """
